...
drop policy if exists "strava_connections own" on public.strava_connections;
...
drop policy if exists "strava_activities own" on public.strava_activities;
...
drop policy if exists "strava_oauth_states own" on public.strava_oauth_states;
