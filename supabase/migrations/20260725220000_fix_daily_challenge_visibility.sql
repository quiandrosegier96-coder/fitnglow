-- Every signed-in member can see published challenges.
-- Only Joyce can create, edit, publish or delete challenge content.
...
-- Keep participation private: members can only start and complete their own row.
